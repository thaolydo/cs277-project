 ...
 * It uses the singleton design pattern, and creates an output file in the
...
public class Logger {
	...
	/**
	 * getLogger() is how to access the logger member variable, as in the singleton
	 * design pattern. If logger is null, it will create a new one.
	 *
	 * @return This logger
	...
	/**
	 * Writes an entry to the log, prefaced by a timestamp of when it was written.
	 * Any message can be passed in here.
	 *
	 * @param message The message to write out to the log.
	 */
	public void log(String message) {
		Instant time = Instant.now();
		DateTimeFormatter format = DateTimeFormatter.ofPattern("uuuu-MM-dd HH:mm:ss:SSS").withLocale(Locale.US)
