...
/**
 * MasterRoach is meant to be a credit card just for roaches. It is one of two
 * payment methods the motel accepts.
 */
public class MasterRoach implements PaymentStrategy {
	...
	public String toString() {
		return String.format("MasterRoach card - Info: Name: %1$s Number: %2$s cvv: %3$s Expiration Date: %4$s.", name,
